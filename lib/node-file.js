...
walk = exports.walk = Walker = (function() {
  ...
  Walker.prototype._deepWalkDirectory = function(p, stat, next) {
    return this._onFolder(p, stat, (function(_this) {
      return function() {
        return fs.readdir(p, function(err, files) {
          var _next;
          if (err) {
  ...
  Walker.prototype._onFolder = function(p, stat, next) {
    var pathObj;
    pathObj = this._getPathObj(p);
    this.emit('directory', pathObj, stat, next);
    this.emit('folder', pathObj, stat, next);
    return this.emit('fad', pathObj, stat);
  };
